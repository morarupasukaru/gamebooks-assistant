...
The french gamebook [Un poignard dans le dos](http://litteraction.fr/livre-jeu/un-poignard-dans-le-dos) by skarn is provided as an example of gamebook; under license [![license](https://i.creativecommons.org/l/by-sa/1.0/88x31.png)](http://creativecommons.org/licenses/by-sa/1.0/).
