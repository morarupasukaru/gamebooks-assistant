...
let paths = {
    ...
    html: [resolveToApp('**/*.html'), path.join(root, 'desktop.html')],
...
gulp.task('build', [], (done) => {
    ...
    // remove commented line if decided to make /books/ public
    gulp.src(path.join(root, 'books/*.json')).pipe(gulp.dest(paths.build));
