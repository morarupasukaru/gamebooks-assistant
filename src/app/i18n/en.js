const englishTranslations = {
    ...
    'Constant': 'Constant',
    'Content of the book (parsed)': 'Content of the book (parsed)',
    'Content of the book (raw)': 'Content of the book (raw)',
    'Continue': 'Continue',
    ...
    'Import a single-page edition project aon book': 'Import a single-page edition project aon book',
    ...
    'MoreThanOneIllustrationInLoneWolfBookParagraph': "There is more than one illustration for the paragraph '{{ paragraphNr }}'",
    'Ok': 'Ok',
    'Paragraph': 'Paragraph',
    ...
    'placeholder.projectaon.book': 'e.g. https://www.projectaon.org/en/xhtml-simple/lw/01fftd.htm',
    'Player': 'Player',
    ...
    'Title': 'Title',
    'UnsupportedTagClassInLoneWolfBook': "tag: '{{ tagName }}', class: '{{ className }}' unknown for paragraphNr: '{{ paragraphNr}}'",
