const frenchTranslations = {
    ...
    'ChooseParagraph': "Sélectionne le paragraphe '{{ paragraph }}'",
    'Clear values': 'Efface les valeurs',
    'Constant': 'Constant',
    'Content of the book (parsed)': 'Contenu du livre (travaillé)',
    'Content of the book (raw)': 'Contenu du livre (brut)',
    'Continue': 'Poursuivre',
    ...
    'EditParagraphChoice': "Edite le choix '{{ paragraph }}'",
    'en': 'English',
    'English': 'English',
    'Enable battle': 'Active les combats',
    "Enable choices available in paragraph's description": 'Active les choix dans la descrption des paragraphes',
    'Enable choices table': 'Active les choix afficher dans un tableau',
    ...
    'Enemy': 'Enemi',
    'Export': 'Exporte',
    'Export libraries': 'Exporte les librairies',
    'Export selected adventure': "Exporte l'aventure sélectionnée",
    'Export text': 'Text exporté',
    'ExportAdventure': "Exporte l'aventure '{{adventureName}}'",
    'ExportGame': "Exporte le jeu de '{{playerName}}' de l'aventure '{{adventureName}}'",
    'export_email': 'Envoi par courriel',
    'export_file': 'Télécharge un fichier',
    'export_text': 'Text',
    ...
    'Import a single-page edition project aon book': "Importe un livre du projet aon au format 'page-unique'",
    'Import an adventure': 'Importe une aventure',
    'Import libraries': 'Importe des librairies',
    'Import text': 'Importe le text',
    ...
    'import_file': 'Télécharger fichier',
    'import_text': 'Text',
    ...
    'Items': 'Objets',
    'Language': 'Langue',
    'LanguageUnsupported': "La langue '{{languageCode}}' n'est pas supportée",
    'Length': 'Longueur',
    ...
    'placeholder.projectaon.book': 'p.ex. https://www.projectaon.org/en/xhtml-simple/lw/01fftd.htm',
    'Player': 'Joueur',
    ...
    'Please fill the paragraph number': 'Veuilliez saisir le numéro de paragraphe',
    ...
    'RemoveParagraphChoice': "Supprime le choix '{{ paragraph }}'",
    ...
    'Select the export method': "Sélectionnez une méthode d'exportation",
    'Select the import method': "Sélectionnez une méthode d'importation",
    'Selection': 'Sélection',
    'Sent': 'Envoyé',
    'Serie': 'Série',
    'Site': 'Site',
    ...
    'Title': 'Titre',
    'UnsupportedTagClassInLoneWolfBook': "tag: '{{ tagName }}', class: '{{ className }}' inconnu pour le numéro paragraphe: '{{ paragraphNr}}'",
